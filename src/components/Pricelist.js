...
import { Calendar, Users, Clock, ChevronDown, ChevronUp, Filter, Star, Download } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <div className="flex space-x-2 overflow-x-auto pb-2 md:pb-0">
            <button
                      ...
                      <div className="mb-6">
                        <label className="block text-sm font-medium text-gray-700 mb-2">Price Range: {formatPrice(priceRange[0])} - {formatPrice(priceRange[1])}</label>
                                ...
                                <div className="flex flex-wrap items-center gap-4 mt-2 text-sm text-gray-600">
                                  ...
                                  <div className="flex items-center">
                                    <span className="font-medium text-gray-800">
                                      From {formatPrice(getMinPrice(pkg))}
                                    </span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="border-t border-gray-200 px-6 py-4">
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                  ...
                                  <div>
                                    ...
                                    <h4 className="font-semibold text-gray-700 mt-4 mb-2">Package Includes</h4>
                                    <ul className="list-disc pl-5 text-sm text-gray-600">
                                ...
                                <div className="mt-6 flex justify-end">
                                  <button className="flex items-center px-4 py-2 bg-amber-600 text-white rounded-md hover:bg-amber-700">

        ...
        <div className="jambo-footer-column flex-1 min-w-[250px] mb-5 px-[25px]">
          ...
          <div className="jambo-contact-info">
            <p className="flex items-center mb-3 text-sm">
              <EnvelopeIcon className="w-4 h-4 mr-3 text-[#8bc34a]" />
              safaris@jambotravelhouseholidays.com
            </p>
            <p className="flex items-center mb-3 text-sm">
              <PhoneIcon className="w-4 h-4 mr-3 text-[#8bc34a]" />
              +254 722 218 901
            </p>
            <p className="flex items-center mb-3 text-sm">
              <MapPinIcon className="w-4 h-4 mr-3 text-[#8bc34a]" />
              Karen, Nairobi Kenya
            </p>
          </div>
        </div>
        ...
        <div className="jambo-footer-column flex-1 min-w-[250px] mb-5 px-[25px]">
          ...
          <div className="mb-5">
            ...
            <div className="flex gap-4 justify-end">
              {[
                { icon: 'twitter', href: '#' },
                { icon: 'facebook', href: 'https://www.facebook.com/Jambo.travel.Safaris?_rdc=1&_rdr' },
                { icon: 'instagram', href: 'https://www.instagram.com/jambo_travelhouse/' },
                { icon: 'linkedin', href: '#' },
                { icon: 'youtube', href: '#' },
                { icon: 'tiktok', href: '#' },
                { icon: 'whatsapp', href: '#' }

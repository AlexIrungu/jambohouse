    ...
    return (
        <div className="min-h-screen bg-stone-50">
            <div className="container mx-auto px-4 py-12 lg:py-16">
                <div className="grid lg:grid-cols-3 gap-8 overflow-hidden rounded-3xl shadow-2xl">
                    {/* Sidebar with Company Information */}
                    <div className="lg:col-span-1 bg-gradient-to-br from-green-800 to-green-900 text-white p-8 lg:p-12">
                        <div className="sticky top-12">
                            ...
                            <div className="space-y-8 mb-12">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-amber-200 font-medium">Email Us</p>
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-amber-200 font-medium">Call Us</p>
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-amber-200 font-medium">Visit Us</p>
                            ...
                            <div className="hidden lg:block">
                                <div className="mt-12 p-6 bg-green-700/30 rounded-xl">
                                    <h3 className="font-semibold text-amber-300 mb-2">Why Choose Us</h3>
                        ...
                        >
                            ...
                            <div className="bg-stone-50 p-6 rounded-xl">
                                <div className="flex items-center space-x-3 mb-6">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-800">Trip Preferences</h3>
                                </div>
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                        {['Kenya', 'Tanzania', 'Uganda', 'Rwanda', 'South Africa'].map((country) => (
                                            <label key={country} className="flex items-center p-3 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-all cursor-pointer">
                                                <Controller
                                                    name="countries"
                                                    control={control}
                                ...
                                <div className="mb-8">
                                    <div className="flex justify-between mb-3">
                                        ...
                                        <Controller
                                            ...
                                            defaultValue={12}
                                            render={({ field: { value } }) => (
                                                <span className="text-sm font-semibold text-green-700">{value} days</span>
                                            )}
                                        />
                                    </div>
                                    <Controller
                            ...
                            <div className="bg-stone-50 p-6 rounded-xl">
                                <div className="flex items-center space-x-3 mb-6">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-800">Activities & Travel Group</h3>
                                </div>
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                                        {['Safari', 'Mountain Climbing', 'Beach Holiday', 'Chimpanzee Trekking', 'Gorilla Trekking', 'Cultural Tours'].map((activity) => (
                                            <label key={activity} className="flex items-center p-3 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-all cursor-pointer">
                                                <Controller
                                                    name="activities"
                                                    control={control}
                                                    render={({ field: { value = [], onChange } }) => (
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                                        {['Honeymoon', 'Family', 'Couple', 'Solo', 'Group of Friends', 'Other'].map((option) => (
                                            <label key={option} className="flex items-center p-3 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-all cursor-pointer">
                                                <Controller
                                                    name="travelWith"
                                                    control={control}
                                                    render={({ field: { value, onChange } }) => (
                            ...
                            <div className="bg-stone-50 p-6 rounded-xl">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all h-32"
                                    />
                                </div>
                            </div>
                            ...
                            <button 
                                ...
                                className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white py-4 px-8 rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-300 font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                            >
                                {isSubmitting ? (
                                    <>

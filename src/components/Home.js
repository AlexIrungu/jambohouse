  ...
  >
    ...
    <div className="text-center max-w-3xl px-4 relative z-10">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <button className="bg-green-600 hover:bg-green-500 px-8 py-4 rounded-full text-lg font-medium shadow-lg transition-all hover:scale-105 focus:ring-4 focus:ring-green-300">
          Plan Your Safari
        </button>
  ...
  <section className="py-20 bg-gray-50">
    <div className="container mx-auto px-4">
      <div className="max-w-xl mx-auto text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Why Choose Wild Horizons</h2>
        <div className="h-1 w-24 bg-green-600 mx-auto mb-6"></div>
        <p className="text-gray-600 text-lg">We combine luxury and adventure to create unforgettable safari experiences that connect you with nature's most spectacular wonders.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-green-600">
          ...
          <h3 className="font-bold text-xl mb-3 text-gray-900">Responsible Travel</h3>
          <p className="text-gray-600">Our commitment to sustainable tourism practices ensures we protect the environments we love for future generations.</p>
        </div>
        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-green-600">
          <div className="bg-green-100 p-4 rounded-full inline-flex mb-6">
            <MapPin className="text-green-700" size={32} />
          </div>
          <h3 className="font-bold text-xl mb-3 text-gray-900">Customizable Journeys</h3>
          <p className="text-gray-600">Every safari is tailored to your preferences, creating a personalized adventure that meets your unique desires.</p>
        </div>
        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-green-600">
          <div className="bg-green-100 p-4 rounded-full inline-flex mb-6">
            <Users className="text-green-700" size={32} />
          </div>
          <h3 className="font-bold text-xl mb-3 text-gray-900">Expert Guides</h3>
          <p className="text-gray-600">Our passionate guides have decades of combined experience and intimate knowledge of Africa's wilderness.</p>
        </div>
        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-green-600">
          <div className="bg-green-100 p-4 rounded-full inline-flex mb-6">
            <Shield className="text-green-700" size={32} />
          </div>
          <h3 className="font-bold text-xl mb-3 text-gray-900">Safety Assured</h3>
          <p className="text-gray-600">Your wellbeing is our priority, with comprehensive safety protocols and 24/7 support throughout your journey.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-col lg:flex-row items-center gap-12">
        <div className="w-full lg:w-1/2 relative">
          ...
          />
          <div className="absolute -bottom-8 -right-8 bg-green-600 text-white p-6 rounded-lg shadow-lg hidden md:block">
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex items-center mb-4">
            ...
            <p className="text-green-600 font-medium uppercase tracking-wider">Our Story</p>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">About Wild Horizons Safari</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              <Globe className="text-green-700 mb-3" size={32} />
              <h4 className="font-bold text-lg mb-1">Global Reach</h4>
              <p className="text-gray-600">Welcoming travelers from across the world</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <Award className="text-green-700 mb-3" size={32} />
              <h4 className="font-bold text-lg mb-1">Award-Winning</h4>
              <p className="text-gray-600">Recognized for exceptional safari experiences</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <Target className="text-green-700 mb-3" size={32} />
              <h4 className="font-bold text-lg mb-1">Personalized</h4>
              <p className="text-gray-600">Tailored journeys for every traveler</p>
            </div>
          </div>
          <button className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-full font-medium transition-all hover:scale-105 inline-flex items-center group">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-xl mx-auto text-center mb-16">
          <div className="flex items-center justify-center mb-4">
            <div className="h-1 w-12 bg-green-600 mr-4"></div>
            <p className="text-green-600 font-medium uppercase tracking-wider">Where Dreams Begin</p>
            <div className="h-1 w-12 bg-green-600 ml-4"></div>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Explore Our Destinations</h2>
          <p className="text-gray-600 text-lg">Discover the diverse landscapes and wildlife that make East Africa a premier safari destination.</p>
        </div>
            ...
            <div key={index} className="group">
              <div className="relative overflow-hidden rounded-xl shadow-lg aspect-[4/5]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <button className="bg-white text-green-800 hover:bg-green-100 px-6 py-2 rounded-full font-medium transition-all inline-flex items-center">
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-xl mx-auto text-center mb-16">
          <div className="flex items-center justify-center mb-4">
            <div className="h-1 w-12 bg-green-600 mr-4"></div>
            <p className="text-green-600 font-medium uppercase tracking-wider">Wildlife Encounters</p>
            <div className="h-1 w-12 bg-green-600 ml-4"></div>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Featured National Parks</h2>
          <p className="text-gray-600 text-lg">Explore Africa's most iconic wildlife sanctuaries, each offering unique ecosystems and unforgettable experiences.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {parks.map((park, index) => (
            <div key={index} className="group bg-gray-50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              <div className="relative h-64 overflow-hidden">
                <img 
                  ...
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                />
                <div className="absolute top-4 right-4 bg-white/80 text-green-800 px-3 py-1 rounded-full text-sm font-medium">
                  {park.country}
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2 text-gray-900">{park.name}</h3>
                <p className="text-gray-600 mb-4">{park.description}</p>
                <button className="text-green-600 hover:text-green-800 font-medium inline-flex items-center group">
                  Explore Park
    ...
    <div className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-xl mx-auto text-center mb-16">
          <div className="flex items-center justify-center mb-4">
            <div className="h-1 w-12 bg-green-600 mr-4"></div>
            <p className="text-green-600 font-medium uppercase tracking-wider">Popular Choices</p>
            <div className="h-1 w-12 bg-green-600 ml-4"></div>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Bestselling Safari Packages</h2>
          <p className="text-gray-600 text-lg">Our most sought-after adventures, loved by travelers worldwide for their perfect blend of wildlife and comfort.</p>
        </div>
            ...
            >
              ...
              <div className="relative z-10 text-white flex flex-col justify-end h-full p-8">
                <div className="space-y-4">
                  ...
                  <button className="w-full bg-white text-green-800 py-3 rounded-full hover:bg-green-50 transition-colors font-medium inline-flex items-center justify-center group">
  ...
  <section className="py-20 bg-white">
    <div className="container mx-auto px-4">
      <div className="max-w-xl mx-auto text-center mb-16">
        <div className="flex items-center justify-center mb-4">
          <div className="h-1 w-12 bg-green-600 mr-4"></div>
          <p className="text-green-600 font-medium uppercase tracking-wider">Curated Experiences</p>
          <div className="h-1 w-12 bg-green-600 ml-4"></div>
        </div>
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Our Safari Experiences</h2>
        <p className="text-gray-600 text-lg">Handcrafted safari journeys designed to fulfill your African adventure dreams.</p>
      </div>
        ...
        {[
          ...
          >
            <div className="h-48 relative overflow-hidden">
              ...
              <div className="absolute top-4 right-4 bg-white text-gray-900 px-4 py-1 rounded-full text-sm font-bold">
                {pkg.price}
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-900 py-3 rounded-lg font-medium inline-flex items-center justify-center group transition-colors">
                View Details
                <ArrowRight className="ml-2 transform group-hover:translate-x-1 transition-transform" size={16} />
              </button>
            </div>
      ...
      <div className="text-center mt-12">
        <button className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-full font-medium shadow-lg transition-all hover:scale-105 inline-flex items-center">
  ...
  const testimonials = [
    {
      ...
      text: "Our Tanzania safari exceeded every expectation. From the moment we landed to our departure, Wild Horizons provided exceptional service and attention to detail. Our guide David was incredibly knowledgeable and passionate. We saw all of the Big Five and so much more!",
    ...
    },
    {
      ...
      text: "The gorilla trekking experience in Rwanda was life-changing. Coming face-to-face with these magnificent creatures in their natural habitat was humbling and profound. The accommodations were luxurious and the staff went above and beyond to make our trip special.",
    ...
    },
    {
      name: "Emma Williams",
      location: "London, UK",
      text: "As a solo female traveler, safety was my top concern. Wild Horizons made me feel secure while providing an authentic African experience. The Masai Mara at sunset is something I'll never forget, and the cultural experiences were respectful and enlightening.",
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-xl mx-auto text-center mb-16">
          <div className="flex items-center justify-center mb-4">
            <div className="h-1 w-12 bg-green-600 mr-4"></div>
            <p className="text-green-600 font-medium uppercase tracking-wider">Happy Travelers</p>
            <div className="h-1 w-12 bg-green-600 ml-4"></div>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">What Our Clients Say</h2>
          <p className="text-gray-600 text-lg">Real stories from travelers who experienced the magic of an African safari with us.</p>
        </div>

        <div className="max-w-4xl mx-auto relative">
          <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-12 relative">
            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-green-600 text-white p-4 rounded-full">
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    <img 
                      ...
                      className="w-20 h-20 rounded-full mb-6 border-4 border-green-100"
                    />
          ...
          <button 
            onClick={prevSlide}
            className="absolute top-1/2 -left-4 transform -translate-y-1/2 bg-white rounded-full p-3 shadow-lg hover:bg-gray-100 transition-colors"
          >
          ...
          <button 
            onClick={nextSlide}
            className="absolute top-1/2 -right-4 transform -translate-y-1/2 bg-white rounded-full p-3 shadow-lg hover:bg-gray-100 transition-colors"
          >
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-xl mx-auto text-center mb-16">
          <div className="flex items-center justify-center mb-4">
            <div className="h-1 w-12 bg-green-600 mr-4"></div>
            <p className="text-green-600 font-medium uppercase tracking-wider">Safari Insights</p>
            <div className="h-1 w-12 bg-green-600 ml-4"></div>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">From Our Blog</h2>
          <p className="text-gray-600 text-lg">Expert advice, travel tips, and inspiring stories from the African wilderness.</p>
        </div>
        ...
        <div className="text-center mt-12">
          <button className="bg-gray-100 hover:bg-gray-200 text-gray-900 px-8 py-4 rounded-full font-medium transition-all hover:scale-105 inline-flex items-center">
            Visit Our Blog
            <ArrowRight className="ml-2" size={18} />
          </button>
        </div>
